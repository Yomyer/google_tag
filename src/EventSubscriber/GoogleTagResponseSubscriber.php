...
EOS;
    ...
    /**
     * This is the generate datalayers hook... hook_datalayer_alter(&$dataLayer)
     *
     * @return string
     *   The datalayers script
     */
    private function hook_tags()
    {
